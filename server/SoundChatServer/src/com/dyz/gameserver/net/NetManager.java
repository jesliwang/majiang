...
public class NetManager {
	...
	public  void startListner(IoHandler iohandler,int listenPort) throws Exception{
		...
		threadpool = new OrderedThreadPoolExecutor(100);//Executors.newCachedThreadPool();//new OrderedThreadPoolExecutor(100);
		threadpool.setThreadFactory(new ServerThreadFactory("OrderedThreadPool"));
		chain.addLast("threadPool", new ExecutorFilter(threadpool));

		int recsize = 1024*1024*64;
		int sendsize = 1024*1024*64;
		int timeout = 10;
		//
