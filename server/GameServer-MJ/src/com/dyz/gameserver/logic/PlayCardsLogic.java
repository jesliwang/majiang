...
//					
        ...
        if((!avatar.inTing) && checkTing(avatar))
        {
        	tingAvatar.add(avatar);
     	   // TODO:
     	   tingId.append(":" + avatar.getUuId());
     	   avatar.getSession().sendMsg(new ReturnInfoResponse(1, tingId.toString()));
        }
