...
public class RulePanelScript : MonoBehaviour {
	...
	void Start () {
        ...
        ruleContents.Add(@"清水麻将规则
一、用牌
1、1-9条、1-9饼、1-9万、东西南北四风、中发共132张（桌面三张牌一组，每人面前11组牌）
2、玩家人数为4人
二、摸牌
1、游戏开始，每人抓13张，庄家多抓1张置于右侧。
2、庄家打出1张牌，其他闲家有权要，胡、杠、碰。
3、打出牌都不要，逆时针下位玩家抓牌。
三、庄家确定
1、第一局房主为庄家。
2、庄家胡牌，连续坐庄。
3、臭庄后，庄家继续坐庄。臭庄3次后轮庄。（臭庄是这局没人胡牌的情况下）
3、闲家胡牌，则换庄，庄家的下家为新庄。
四、杠  碰
1、明杠：包括点杠和补杠。
2、暗杠：自己抓到四张牌开杠，并从牌堆末端补一张牌。能否暗杠留手，以后再进行暗杠操作（可以留手，随时暗杠）
3、点杠：自己手上有三张，他人打出第四张。
4、补杠：碰了以后自己摸到另外一张牌，可以立即杠牌，也可以留在手中过几手（根据自己的需求来决定是牌留着还是杠牌，如果有其他人听牌，你要杠牌的话刚好这张牌人家需要算点炮，另外你听牌后杠出来的牌有玩家胡牌的话也算点炮）。
5、明杠时有截胡，此时杠不生效。（这个属于抢胡）
6、打出的牌其它三家都能碰。（听牌后其他玩家打出的牌不能碰牌，也不能杠。只能暗杠）
五、胡牌
十三张牌乱拼，不限花色，但必须要有最少一副将也可以胡7对子（7对子不限制有几副将的问题）（将即为对子）胡牌（比如123万或者789万这类牌型混搭在一起都行，也就是其他地区麻将里面所谓的屁胡）（比如手中有1234万，刚好都碰出来了最后只能就单吊一个将了）
流摸、打、吃、碰、杠牌的过程，将手中的牌组合成顺子、刻子或杠子，这些每三张或每四张一组所组合完成的牌，就称为「面子」。一副牌必须凑成五组面子以及一组对子，才可以胡牌。如果是别家打出一张牌，刚好可以让自己凑成胡牌型态时，即可叫「胡牌」，该家就称为放炮或点炮，此时只有算放炮者输（必须是没听牌的玩家,如果听牌的话可以看做是平胡,即其他三家都算输）；若是由自己摸进的牌胡牌，则称为「自摸」，其他三家皆算输
六、计算输赢
1、坐庄每次平胡（每位玩家-2分）
2、坐庄自摸胡（每位玩家-4分）
3、坐庄点炮算6分（只扣点炮人的分其他玩家不用扣分）
4、闲家每次平胡（庄家-2分其他两家-1分）
5、闲家自摸一次庄家-4分其他闲家-2分
6、闲家被点炮一次得4分（只扣点炮人分）
（平胡就是都听牌的玩家摸出来的牌被胡，不算点炮）
");
